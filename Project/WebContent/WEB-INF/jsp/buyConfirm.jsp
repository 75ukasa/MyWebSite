				...
				<dl class="kijilist clearfix">
					...
					<c:if test = "${orderData.nameColorBeans1.colorType != null}">
						<c:if test = "${orderData.nameColorBeans1.colorPrice > 0}">
							...
							<dd>小計  :   ${orderData.nameColorBeans1.colorPrice}円＋税</dd>
						</c:if>
					</c:if>
