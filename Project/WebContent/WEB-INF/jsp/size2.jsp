		...
		<div class="contents wrap">
			<div class="confirm">
				...
				<table class="table1 fixed v_top wid800">
			        <tbody>
				        <tr>
			                <td><img src="./img/size/title_kubi.jpg" border="0" align="top"><br>
				                <br>
				                首周り（ネックサイズ）の採寸です。<br>
				                <br>
			                ...
			                <td><img src="./img/size/neck1.jpg" border="0" align=""><br><img src="./img/size/neck2.jpg" border="0"><br></td>
		                </tr>

		                <tr>
			                <td valign="top"><img src="./img/size/title_katahaba.jpg" border="0"><br>
				                <br>
				                お気に入りのシャツの肩巾の採寸方法です。片側の肩先から衿の後ろの中心までを計り、更にもう片一方も衿の後ろから肩先にかけて計って下さい。それを足したものが肩幅になります。<br>
				                <br>
				                採寸の際には肩の縫い代は肩巾に加えて頂ければと思います。<br>
				                <br>
				                右の写真やその下に貼ってあります。Youtubeの動画を確認頂きましてお計り頂ければと思います。<br>
				                <br>
				                ご着用のシャツの肩巾が狭いと感じた場合はこのサイズにプラスして頂ければと思いますが、あまり肩巾が広いと逆に袖が上がりにくくなる場合もございます。<br><br>ご着用になった際に肩先の先端の骨の所にシャツの肩巾がきていればそのシャツはジャストサイズと言えると思います。
			                </td>
		                	<td><img src="./img/size/katahaba1.jpg" border="0" align="top"><br><img src="./img/size/katahaba2.jpg" border="0"><br></td>
		                </tr>

		                <tr>
			                <td valign="top"><img src="./img/size/title_yukitake.jpg" border="0"><br>
				                <br>
				               （衿の真後ろ、ヨークの中心、肩幅の半分）より肩先を通してカフスの先まで計ります。<br>
				                <br>
				                基本的に５ミリ単位です。左右の長さが違う人が当店の経験上半数くらいはいらっしゃいますので、左右をお計り下さい。<br>
				                <br>
				                ジャストサイズのシャツをご着用の場合はカフスの先までお計り頂ければと思います。<br>
				                <br>
			                 	袖ははしっかりと伸ばしてお計り下さい。
		                 	</td>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_ah.jpg" border="0" align="top"><br>
				                <br>
				                アームホール（袖周り）のサイズです。肩の縫い目の所から脇の下までの縫い目を直線で計ります。<br>
				                <br>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_bust.jpg" border="0"><br>
				                <br>
				                上胴（バスト）のお採寸です。特に難しことはありません。脇の下辺を真っ直ぐにお計り下さい。<br>
				                <br>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_waist.jpg" border="0" align="top"><br>
				                <br>
				                中胴（ウエスト）の採寸です。上胴と同じように採寸して頂ければと思います。<br>
				                <br>
				                目安としてはおへその辺り。シャツで言いますと一番くぼみがある部分が中胴（ウエスト）の部分になります。<br>
				                <br>
				                こちらに関しても上胴同様、計測して頂いた数値の２倍が中胴サイズとなります。
			                </td>
		                	<td><img src="./img/size/waist.jpg" border="0" align="top"><br></td>
		                </tr>

		                <tr>
			                <td valign="top"><img src="./img/size/title_hip.jpg" border="0" align="top"><br>
				                <br>
				                下胴（ヒップ）の採寸です。上胴中胴と同様な採寸方法で良いと思います。裾の部分をお計り下さい。<br>
				                <br>
				                こちらに関しても上胴、中胴、同様、計測して頂いた数値の２倍が中胴サイズとなります。
				                </td>
			                <td><img src="./img/size/hip.jpg" border="0" align="top"><br></td>
		                </tr>

		                <tr>
			                <td valign="top"><img src="./img/size/title_kitake.jpg" border="0" align="top"><br>
				                <br>
				                シャツの丈、着丈の採寸です。衿の直ぐ下、ヨークと衿の境目から真っ直ぐに裾までを計測します。<br>
				                <br>
				                <br>
				            </td>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_cuffs.jpg" border="0"><br>
			                <br>
				                カフス周りの採寸です。カフスの右端から左端までの全長をお計り下さい。<br>
				                <br>
			                ...
			                <td><img src="./img/size/cuffs.jpg" border="0" align="top"><br><iframe  frameborder="0" allowfullscreen="" class="stube"></iframe></td>
		                </tr>
	         		</tbody>
	         	</table>
