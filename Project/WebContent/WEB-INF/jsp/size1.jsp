		...
		<div class="contents wrap">
			<div class="confirm">
				...
				<table class="table1 fixed v_top">
	                <tbody>
		                <tr>
			                <td valign="top"><img src="./img/size/title_kubi.jpg" border="0"><br>
				                <br>
				                首周り（ネックサイズ）の採寸です。<br>
				                <br>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_katahaba.jpg" border="0"><br>
				                ...
				                <br>
				                シャツのゆとり（ゆるみ）は大きくとったとしても肩巾はジャストサイズをお勧め致します。
				            </td>
			                <td><img src="./img/size/katahaba.jpg" border="0"><br></td>
		                </tr>

		                <tr>
		                	<td valign="top"><img src="./img/size/title_yukitake.jpg" border="0">
				                <br>
				                衿の真後ろ、ヨークの中心、肩幅の半分）より肩先を通してカフスの先まで計ります。<br>
				                <br>
				                基本的に５ミリ単位です。左右の長さが違う人が当店の経験上半数くらいはいらっしゃいますので、左右をお計り下さい。<br>
				                <br>
				                ジャストサイズのシャツをご着用の場合はカフスの先まで、シャツをご着用でない場合は、基本的には手の骨のグリグリより１．５センチ～２センチ程長く（下方向　手首のくびれがある所　個人差があり）お計りになられれば良いと思います。この位置を基本にして長めがお好きか短めがお好きかで裄丈のサイズを決定して頂ければと思います。
			                </td>
		                ...
		                <tr>
							<td valign="top"><img src="./img/size/title_ah.jpg" border="0" align="top"><br>
				                <br>
				                アームホール（袖周り）のサイズです。脇の下から肩先（骨の上）を通って1周計ります。<br>
				                <br>
				                袖を下ろした状態で、しっかりとお計り頂ければと思います。ルーズに計る必要もあまりありません。<br>
				                <br>
				                <br>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_bust.jpg" border="0"><br>
				                ...
				                <br>
				                <br>
				                背中側にメジャーのたるみの無いように採寸して頂ければと思います。<br>
				                <br>
			                </td>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_hip.jpg" border="0" align="top"><br>
				                ...
				                <br>
				                <br>
				                採寸時に後ろ側でメジャーがたるまないように気を付けて頂ければと思います。
			                </td>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_kitake.jpg" border="0" align="top"><br>
				                <br>
				                シャツの丈、着丈の採寸です。衿の直ぐ下、ヨークと衿の継ぎ目から真っ直ぐにお尻の下までを計測します。<br>
				                <br>
				                <br>
				                ...
				                <br>
				                <br>
				                その際には脇からシャツが出ないように裾のカーブを浅く裁断するように致します。
			                </td>
		                ...
		                <tr>
			                <td valign="top"><img src="./img/size/title_cuffs.jpg" border="0"><br>
				                <br>
				                カフス周りの採寸です。カフスの大きさを決定する訳ですが、ここでは実寸をご記入下さい。<br>
				                <br>
			                ...
			                <td><img src="./img/size/cuffs (1).jpg" border="0"><br><iframe></iframe></td>
		                </tr>
					</tbody>
				</table>
				...
				<table class="wid726 fixed">
					<tbody>
						<tr>
							<td>
								<img src="./img/size/buck.jpg" border="0">
							</td>
							<td>
								<img src="./img/size/front.jpg" border="0">
							</td>
						</tr>
					</tbody>
				</table>
